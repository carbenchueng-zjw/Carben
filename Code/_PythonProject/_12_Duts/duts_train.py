...
from duts_data import Duts_Dataset
from UNet import *

module = "./params/unet_duts/unet_duts.pt"
img_save = "./train_img/unet_duts"
# li = os.listdir(module)
# print(li)
net = UNet().cuda()
opt = torch.optim.Adam(net.parameters())
fc_loss = MSELoss()
voc_dataloader = DataLoader(Duts_Dataset(),batch_size=16,shuffle=False)
